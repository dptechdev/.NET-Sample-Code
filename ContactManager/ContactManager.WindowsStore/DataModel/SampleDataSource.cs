...
using ContactManager.WindowsStore.DataModel;
...
namespace ContactManager.WindowsStore.Data
{
    ...
    public sealed class SampleDataSource
    {
        ...
        public static async Task<SampleDataGroup> LoadDataAsync(bool clear = true)
        {
            ...
            const string serviceUrl = "http://localhost:21459/";
            if (clear)
            {
                ...
                Contact[] contacts = await
                    response.Content.ReadAsAsync<Contact[]>();
                SampleDataGroup contactsGroup = new SampleDataGroup(
                   "ContactsGroup", "My Contacts", null, null, null);
                ...
                _sampleDataSource.Groups.Add(contactsGroup);
